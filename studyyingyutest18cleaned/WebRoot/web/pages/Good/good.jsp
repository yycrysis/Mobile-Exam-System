    ...
    $('#grid1').datagrid({
        ...
        columns: [
            [
                ...
                {title: '标题', width: 100, field: 'gname', sortable: true},
...
<div id="managerDialog" class="easyui-dialog" title="学习资料管理" style="width:650px;height:350px;" toolbar="#dlg-toolbar"
...
<!--         <input id="sid" name="good.sid" value="1" type="hidden" style="width:200px;word-wrap: break-word;word-break:break-all;" />
        ...
        <table cellpadding="1" cellspacing="1" class="tb_custom1">
            <tr>
                ...
                <th width="30%" align="right"><label>分类课程：</label></th>
                <td width="30%">
          ...
          <%--  <tr>
                ...
                <td width="30%" colspan="3">
                    <select id="btype" name="good.btype" style="width:200px;word-wrap: break-word;word-break:break-all;" >
            ...
            <th width="30%" align="right"><label>分类：</label></th>
                ...
                <th width="30%" align="right"><label>选择文件：</label></th>
                <td colspan="" width="30%">
